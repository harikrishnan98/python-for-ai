...
my_dict.get("age")
my_dict.get("mstatus", "UnMarried") # Return the value for key if key is in the dictionary, else default.
...
students = {
    ...
    "section": "B-Tech",
    "rollNo": 160213,
    "projInfo": {"name": "ML Weather Forecasting", "types": {"miniProject": "yes", "grade": "O", "paperPublished": True}}
}
...
eligible_for_uk_visa = 'Eligible' if int(hk_info["age"]) < 30 else 'Eligible' if hk_info["hobby"] == 'code' else "He is Not Eligible"
...
try:
    ...
    print('Hi There this is an error')
else:
